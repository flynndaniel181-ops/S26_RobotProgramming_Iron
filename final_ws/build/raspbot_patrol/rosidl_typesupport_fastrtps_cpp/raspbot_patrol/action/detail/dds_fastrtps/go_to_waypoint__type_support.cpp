...
#include "raspbot_patrol/action/detail/go_to_waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_Goal & ros_message)
{
  // Member: waypoint_index
  cdr >> ros_message.waypoint_index;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raspbot_patrol::action::GoToWaypoint_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_Goal *>(
    untyped_ros_message);
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_Goal)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raspbot_patrol
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = raspbot_patrol::action::GoToWaypoint_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_Result)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raspbot_patrol
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_Feedback & ros_message)
{
  // Member: distance_to_waypoint
  cdr >> ros_message.distance_to_waypoint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = raspbot_patrol::action::GoToWaypoint_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_Feedback)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_Feedback__handle;
}
...
// functions for raspbot_patrol::action::GoToWaypoint_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raspbot_patrol
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  raspbot_patrol::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  raspbot_patrol::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    raspbot_patrol::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        raspbot_patrol::action::typesupport_fastrtps_cpp::max_serialized_size_GoToWaypoint_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = raspbot_patrol::action::GoToWaypoint_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_SendGoal_Request)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raspbot_patrol
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = raspbot_patrol::action::GoToWaypoint_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_SendGoal_Response)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal_Response__handle;
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_SendGoal)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raspbot_patrol
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = raspbot_patrol::action::GoToWaypoint_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_GetResult_Request)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for raspbot_patrol::action::GoToWaypoint_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raspbot_patrol
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        raspbot_patrol::action::typesupport_fastrtps_cpp::max_serialized_size_GoToWaypoint_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = raspbot_patrol::action::GoToWaypoint_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_GetResult_Response)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult_Response__handle;
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_GetResult)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_GetResult__handle;
}
...
// functions for raspbot_patrol::action::GoToWaypoint_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raspbot_patrol
cdr_serialize(
  const raspbot_patrol::action::GoToWaypoint_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raspbot_patrol::action::GoToWaypoint_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        raspbot_patrol::action::typesupport_fastrtps_cpp::max_serialized_size_GoToWaypoint_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = raspbot_patrol::action::GoToWaypoint_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raspbot_patrol::action::GoToWaypoint_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<raspbot_patrol::action::GoToWaypoint_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raspbot_patrol, action, GoToWaypoint_FeedbackMessage)() {
  return &raspbot_patrol::action::typesupport_fastrtps_cpp::_GoToWaypoint_FeedbackMessage__handle;
}
